...
const impl_list_map_t &regular_f16_impl_list_map() {
    static const impl_list_map_t the_map = REG_REORDER_P({
        ...
        {{f16, data_type::undef, 0}, {
            ...
            REG_SR(f16, any, f8_e5m2, any, fmt_order_any, spec::reference)
            REG_SR(f16, any, f8_e4m3, any, fmt_order_any, spec::reference)
            REG_SR(f16, any, f16, any, fmt_order_any, spec::reference)
            REG_SR(f16, any, f32, any, fmt_order_any, spec::reference)
            REG_SR(f16, any, s8, any, fmt_order_any, spec::reference)
            REG_SR(f16, any, u8, any, fmt_order_any, spec::reference)
